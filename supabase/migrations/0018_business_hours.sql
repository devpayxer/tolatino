...
-- when an earlier overload also exists never trips "42725: not unique".
grant execute on function public.create_business(
  text, text, text[], text, text, text, text, text, text, text, text, text, double precision, double precision, text[], jsonb
) to authenticated;
