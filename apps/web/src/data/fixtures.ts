...
export const BUSINESSES: Business[] = [
  { id: 0, slug: 'taqueria-la-esperanza', name: 'Taquería La Esperanza', cat: 'FoodDrinks', subcats: ['Taquería', 'Tacos', 'Mexicana'], features: ['A domicilio', 'Para llevar', 'Comedor', 'Apto para niños', 'Se habla español'], rating: '4.9', reviews: 320, dist: '0.8 mi', price: '$$', open: true, verified: true, endorse: 47, t: ['#ECE3F8', '#E3D7F4'], specEs: 'Especialidad · Tacos al pastor', specEn: 'Specialty · Tacos al pastor', amEs: ['A domicilio', 'Español', 'Estacionamiento'], amEn: ['Delivery', 'Spanish', 'Parking'], revEs: '“El mejor pastor de Houston, sin exagerar.” — Carlos R.', revEn: '“Best pastor in Houston, no joke.” — Carlos R.' },
  ...
  { id: 5, slug: 'abogada-ramirez', name: 'Abogada Ramírez', cat: 'ProServices', subcats: ['Abogado', 'Abogado de inmigración', 'Notario'], features: ['Consulta gratis', 'Planes de pago', 'Bilingüe'], rating: '4.9', reviews: 42, dist: '4.0 mi', price: '$$$', open: true, verified: true, endorse: 12, t: ['#E8E4FB', '#DCD6F6'], specEs: 'Especialidad · Inmigración', specEn: 'Specialty · Immigration', amEs: ['Consulta gratis', 'Español', 'Planes de pago'], amEn: ['Free consult', 'Spanish', 'Payment plans'], revEs: '“Nos guió en todo el proceso con paciencia.” — Roberto M.', revEn: '“Guided us through it all patiently.” — Roberto M.' },
  { id: 6, slug: 'lavado-express-sol', name: 'Lavado Express Sol', cat: 'AutoServices', subcats: ['Autolavado', 'Detallado', 'Polarizado'], features: ['Servicio express', 'Estacionamiento'], rating: '4.5', reviews: 64, dist: '2.0 mi', price: '$', open: true, verified: false, endorse: 0, t: ['#E5EFFB', '#D7E5F6'], specEs: 'Especialidad · Detallado completo', specEn: 'Specialty · Full detail', amEs: ['Sin cita', 'Rápido'], amEn: ['Walk-in', 'Fast'], revEs: '', revEn: '' },
