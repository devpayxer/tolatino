...
export const FEED_KIND: Record<FeedKind, { es: string; en: string; bg: string; color: string }> = {
  ...
  sale: { es: 'Vende', en: 'For sale', bg: '#DAF6FD', color: '#007FA2' },
...
export const FEED_SAMPLE: FeedTeaser[] = [
  ...
  { initials: 'AM', color: '#007FA2', who: 'Ana M.', kind: 'job', hood: 'Pasadena', agoEs: 'hace 35 min', agoEn: '35 min ago',
  ...
  { initials: 'MV', color: '#AE54A5', who: 'Marisol V.', kind: 'rec', hood: 'Gulfton', agoEs: 'hace 2 h', agoEn: '2 h ago',
    es: 'Barbería El Corte me atendió sin cita, excelente.', en: 'Barbería El Corte took me without an appointment, excellent.' },
  { initials: 'DG', color: '#008489', who: 'Diana G.', kind: 'ask', hood: 'Bellaire', agoEs: 'hace 3 h', agoEn: '3 h ago',
  ...
  { initials: 'IV', color: '#008489', who: 'Irma V.', kind: 'rec', hood: 'Bellaire', agoEs: 'hace 8 h', agoEn: '8 h ago',
    es: 'Clínica Salud Latina atiende en español y sin cita.', en: 'Clínica Salud Latina serves in Spanish, no appointment needed.' },
  { initials: 'HD', color: '#AE54A5', who: 'Hugo D.', kind: 'evt', hood: 'Northside', agoEs: 'hace 9 h', agoEn: '9 h ago',
    es: 'Kermés de la iglesia el sábado, habrá antojitos y música.', en: 'Church kermés on Saturday, food and live music.' },
  { initials: 'TS', color: '#007FA2', who: 'Tania S.', kind: 'rec', hood: 'Spring Branch', agoEs: 'hace 10 h', agoEn: '10 h ago',
