...
export const FEED_KIND: Record<FeedKind, { es: string; en: string; bg: string; color: string }> = {
  ask: { es: 'Busca servicio', en: 'Needs a pro', bg: '#FCEFD6', color: '#9A6A12' },
  rec: { es: 'Recomienda', en: 'Recommends', bg: '#E3F5EA', color: '#1F8A4C' },
  job: { es: 'Empleo', en: 'Job', bg: '#EFEBFF', color: '#6D4DF6' },
  sale: { es: 'Vende', en: 'For sale', bg: '#E4EEFB', color: '#2A6CB0' },
  rent: { es: 'Renta', en: 'Rental', bg: '#FCE9D6', color: '#C26A1A' },
  evt: { es: 'Evento', en: 'Event', bg: '#FDE7EF', color: '#D6336C' },
};
...
export const FEED_SAMPLE: FeedTeaser[] = [
  ...
  { initials: 'OM', color: '#6D4DF6', who: 'Omar M.', kind: 'evt', hood: 'Sharpstown', agoEs: 'hace 11 h', agoEn: '11 h ago',
    es: 'Torneo de fútbol llanero el domingo, faltan dos equipos.', en: 'Sunday pickup soccer tournament, two teams still needed.' },
  { initials: 'BC', color: '#1F9D57', who: 'Brenda C.', kind: 'rec', hood: 'Gulfton', agoEs: 'hace 12 h', agoEn: '12 h ago',
    es: 'Las uñas de Nayeli quedan preciosas y dura semanas.', en: 'Nayeli does beautiful nails and they last for weeks.' },
  { initials: 'FR', color: '#F4B740', who: 'Fernando R.', kind: 'evt', hood: 'Salón Tropicana', agoEs: 'hace 14 h', agoEn: '14 h ago',
