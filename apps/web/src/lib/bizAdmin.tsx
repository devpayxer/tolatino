...
import type { Rubro, Tier } from '@/screens/negocio/tabs';
...
const COLS =
  'id,slug,name,category_id,tagline_es,tagline_en,tier,price_level,about_es,about_en,address,city,phone,hours,features,subcategories,specialty_es,specialty_en,is_open,rating,reviews_count,tile_a,tile_b,created_at';
...
const WRITABLE: (keyof BizRow)[] = [
  ...
  'address', 'city', 'phone', 'hours', 'features', 'subcategories', 'specialty_es', 'specialty_en', 'is_open',
];
