  ...
  const verMas = () =>
    act.hayMas ? (
      <button
        ...
        className="tap-y mx-auto mt-3 cursor-pointer rounded-btn border border-line bg-white px-5 py-2.5 text-[13px] font-extrabold text-primary-dark disabled:opacity-60"
      >
      ...
      <Overlay open={orderSelId !== null} onClose={() => closeOrder()} width={460} fullHeightSheet>
        {(() => {
          ...
          const reportBlock = !reportOpen ? (
            <button onClick={() => setReportOpen(true)} className="flex w-full items-center gap-3 rounded-card border border-line bg-white p-3.5 text-left">
              <span className="flex h-9 w-9 flex-none items-center justify-center rounded-tile bg-pink-bg"><Flag size={17} stroke={2.2} className="text-pink-dark" /></span>
          ...
          if (delivered) {
            return (
              <>
                ...
                <div className="mt-3 flex items-center justify-between rounded-card border border-line bg-white p-3.5">
                  <div className="min-w-0">
                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  <button onClick={() => setShowReceipt((v) => !v)} className="flex w-full items-center gap-3 rounded-card border border-line bg-white p-3.5 text-left">
          ...
          return (
            <>
              ...
              {/* from / to (delivery) */}
              {isDel && f.address && (
                <div className="mt-3 rounded-card border border-line bg-white p-3.5 text-[12.5px] font-semibold">
